			...
			<h2>BeansPick 등록하기</h2>
				...
				<table class="table table-sm">
					...
					<tbody>
						...
						<tr>
							<td>BeansPick 제목 :</td>
							<td colspan=1><input type="text" name="beansTitle" placeholder="제목을 입력하세요" required="required" size=50 id="registCafeName">&nbsp; <span id="nameCheckResult"></span>/10</td>
						</tr>
						<tr>
							<td>BeansPick 본문 :</td>
						</tr>
						...
						<tr>
							<td colspan="3" align="center"><input type="submit" class="btn btn-primary" style="text-align: right" value="등록하기"></td>
						</tr>
					</tbody>
				</table>
			</form>
