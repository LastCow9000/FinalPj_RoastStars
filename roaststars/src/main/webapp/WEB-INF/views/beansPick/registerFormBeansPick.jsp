			...
			<form method="post" action="${pageContext.request.contextPath}/register-result-beansPick.do" id="registerForm" enctype="multipart/form-data">
				...
				<table class="table table-sm">
					...
					<tbody>
						...
						<tr>
							<td>BeansPick 제목 :</td>
							<td colspan=1><input type="text" name="beansTitle" size=50 id="registCafeName" placeholder="BeansPick 제목을 입력해주세요" required="required">&nbsp;
						...
						<tr>
							<td colspan="3"><textarea rows="7" cols="100" placeholder="본문 내용을 입력하세요" id="beansPickInfo" name="beansContent" required="required"></textarea>
